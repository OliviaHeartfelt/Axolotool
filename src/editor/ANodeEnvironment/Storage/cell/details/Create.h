...
namespace NDCellDetails::Create {
    ...
    inline bool create(QSqlQuery& query, const Config::CreateCellRecord& newCell, const bool overrideOnCollision = false) {
        ...
        query.prepare(R"(
            INSERT OR IGNORE INTO node_cells (id,  node_id,  name,  layout_row,  layout_col,  layout_row_span,  layout_col_span,  pin_template_id,  pin_instance_id,  widget_id,  is_out)
